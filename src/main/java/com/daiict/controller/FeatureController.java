...
public class FeatureController {
	...
	public String FeatureUpdateById(@PathVariable("feature_id") int feature_id, @Valid @RequestBody Features feature) {
	...
	public  String addFeature(@Valid @RequestBody Features feature) {
